...
public class GeneratedTest_SiteEdges_ClosedBorders
{
    ...
    public void FivePointsInAForkedStubbyCross_Rotated180()
    {
        ...
        Assert.That(sites[0].Cell, Is.Not.Null);
        Assert.That(sites[0].Cell.Count(), Is.EqualTo(3)); // #1
        Assert.That(HasEdge(sites[0].Cell, 500, 500, 1000, 0), Is.True); // #1 has B-C
        Assert.That(HasEdge(sites[0].Cell, 500, 500, 0, 0), Is.True); // #1 has B-D
        Assert.That(HasEdge(sites[0].Cell, 0, 0, 1000, 0), Is.True); // #1 has D-C
        Assert.That(sites[1].Cell, Is.Not.Null);
        Assert.That(sites[1].Cell.Count(), Is.EqualTo(4)); // #2
        Assert.That(HasEdge(sites[1].Cell, 500, 700, 500, 500), Is.True); // #2 has A-B
        Assert.That(HasEdge(sites[1].Cell, 500, 500, 1000, 0), Is.True); // #2 has B-C
        Assert.That(HasEdge(sites[1].Cell, 500, 700, 1000, 700), Is.True); // #2 has A-E
        Assert.That(HasEdge(sites[1].Cell, 1000, 0, 1000, 700), Is.True); // #2 has C-E
        Assert.That(sites[2].Cell, Is.Not.Null);
        Assert.That(sites[2].Cell.Count(), Is.EqualTo(4)); // #3
        Assert.That(HasEdge(sites[2].Cell, 500, 700, 1000, 700), Is.True); // #3 has A-E
        Assert.That(HasEdge(sites[2].Cell, 500, 700, 500, 1000), Is.True); // #3 has A-G
        Assert.That(HasEdge(sites[2].Cell, 1000, 700, 1000, 1000), Is.True); // #3 has E-X
        Assert.That(HasEdge(sites[2].Cell, 1000, 1000, 500, 1000), Is.True); // #3 has X-G
        Assert.That(sites[3].Cell, Is.Not.Null);
        Assert.That(sites[3].Cell.Count(), Is.EqualTo(4)); // #4
        Assert.That(HasEdge(sites[3].Cell, 500, 700, 0, 700), Is.True); // #4 has A-F
        Assert.That(HasEdge(sites[3].Cell, 500, 700, 500, 1000), Is.True); // #4 has A-G
        Assert.That(HasEdge(sites[3].Cell, 500, 1000, 0, 1000), Is.True); // #4 has G-Y
        Assert.That(HasEdge(sites[3].Cell, 0, 1000, 0, 700), Is.True); // #4 has Y-F
        Assert.That(sites[4].Cell, Is.Not.Null);
        Assert.That(sites[4].Cell.Count(), Is.EqualTo(4)); // #5
        Assert.That(HasEdge(sites[4].Cell, 500, 700, 500, 500), Is.True); // #5 has A-B
        Assert.That(HasEdge(sites[4].Cell, 500, 500, 0, 0), Is.True); // #5 has B-D
        Assert.That(HasEdge(sites[4].Cell, 500, 700, 0, 700), Is.True); // #5 has A-F
        Assert.That(HasEdge(sites[4].Cell, 0, 700, 0, 0), Is.True); // #5 has F-D
    }
    ...
    public void FivePointsInAForkedStubbyCross_Rotated270()
    {
        ...
        Assert.That(sites[0].Cell, Is.Not.Null);
        Assert.That(sites[0].Cell.Count(), Is.EqualTo(3)); // #1
        Assert.That(HasEdge(sites[0].Cell, 500, 500, 0, 0), Is.True); // #1 has B-C
        Assert.That(HasEdge(sites[0].Cell, 500, 500, 0, 1000), Is.True); // #1 has B-D
        Assert.That(HasEdge(sites[0].Cell, 0, 1000, 0, 0), Is.True); // #1 has D-C
        Assert.That(sites[1].Cell, Is.Not.Null);
        Assert.That(sites[1].Cell.Count(), Is.EqualTo(4)); // #2
        Assert.That(HasEdge(sites[1].Cell, 700, 500, 500, 500), Is.True); // #2 has A-B
        Assert.That(HasEdge(sites[1].Cell, 500, 500, 0, 0), Is.True); // #2 has B-C
        Assert.That(HasEdge(sites[1].Cell, 700, 500, 700, 0), Is.True); // #2 has A-E
        Assert.That(HasEdge(sites[1].Cell, 0, 0, 700, 0), Is.True); // #2 has C-E
        Assert.That(sites[2].Cell, Is.Not.Null);
        Assert.That(sites[2].Cell.Count(), Is.EqualTo(4)); // #3
        Assert.That(HasEdge(sites[2].Cell, 700, 500, 700, 0), Is.True); // #3 has A-E
        Assert.That(HasEdge(sites[2].Cell, 700, 500, 1000, 500), Is.True); // #3 has A-G
        Assert.That(HasEdge(sites[2].Cell, 700, 0, 1000, 0), Is.True); // #3 has E-X
        Assert.That(HasEdge(sites[2].Cell, 1000, 0, 1000, 500), Is.True); // #3 has X-G
        Assert.That(sites[3].Cell, Is.Not.Null);
        Assert.That(sites[3].Cell.Count(), Is.EqualTo(4)); // #4
        Assert.That(HasEdge(sites[3].Cell, 700, 500, 700, 1000), Is.True); // #4 has A-F
        Assert.That(HasEdge(sites[3].Cell, 700, 500, 1000, 500), Is.True); // #4 has A-G
        Assert.That(HasEdge(sites[3].Cell, 1000, 500, 1000, 1000), Is.True); // #4 has G-Y
        Assert.That(HasEdge(sites[3].Cell, 1000, 1000, 700, 1000), Is.True); // #4 has Y-F
        Assert.That(sites[4].Cell, Is.Not.Null);
        Assert.That(sites[4].Cell.Count(), Is.EqualTo(4)); // #5
        Assert.That(HasEdge(sites[4].Cell, 700, 500, 500, 500), Is.True); // #5 has A-B
        Assert.That(HasEdge(sites[4].Cell, 500, 500, 0, 1000), Is.True); // #5 has B-D
        Assert.That(HasEdge(sites[4].Cell, 700, 500, 700, 1000), Is.True); // #5 has A-F
        Assert.That(HasEdge(sites[4].Cell, 700, 1000, 0, 1000), Is.True); // #5 has F-D
    }
    ...
    public void FivePointsInARegularKite()
    {
        ...
        Assert.That(sites[0].Cell, Is.Not.Null);
        Assert.That(sites[0].Cell.Count(), Is.EqualTo(5)); // #1
        Assert.That(HasEdge(sites[0].Cell, 500, 1000, 500, 800), Is.True); // #1 has A-E
        Assert.That(HasEdge(sites[0].Cell, 0, 500, 200, 500), Is.True); // #1 has B-F
        Assert.That(HasEdge(sites[0].Cell, 200, 500, 500, 800), Is.True); // #1 has F-E
        Assert.That(HasEdge(sites[0].Cell, 0, 1000, 500, 1000), Is.True); // #1 has X-A
        Assert.That(HasEdge(sites[0].Cell, 0, 500, 0, 1000), Is.True); // #1 has B-X
        Assert.That(sites[1].Cell, Is.Not.Null);
        Assert.That(sites[1].Cell.Count(), Is.EqualTo(5)); // #2
        Assert.That(HasEdge(sites[1].Cell, 500, 0, 500, 200), Is.True); // #2 has C-G
        Assert.That(HasEdge(sites[1].Cell, 0, 500, 200, 500), Is.True); // #2 has B-F
        Assert.That(HasEdge(sites[1].Cell, 500, 200, 200, 500), Is.True); // #2 has G-F
        Assert.That(HasEdge(sites[1].Cell, 500, 0, 0, 0), Is.True); // #2 has C-Y
        Assert.That(HasEdge(sites[1].Cell, 0, 0, 0, 500), Is.True); // #2 has Y-B
        Assert.That(sites[2].Cell, Is.Not.Null);
        Assert.That(sites[2].Cell.Count(), Is.EqualTo(5)); // #3
        Assert.That(HasEdge(sites[2].Cell, 1000, 500, 800, 500), Is.True); // #3 has D-H
        Assert.That(HasEdge(sites[2].Cell, 500, 0, 500, 200), Is.True); // #3 has C-G
        Assert.That(HasEdge(sites[2].Cell, 800, 500, 500, 200), Is.True); // #3 has H-G
        Assert.That(HasEdge(sites[2].Cell, 1000, 500, 1000, 0), Is.True); // #3 has D-W
        Assert.That(HasEdge(sites[2].Cell, 1000, 0, 500, 0), Is.True); // #3 has W-C
        Assert.That(sites[3].Cell, Is.Not.Null);
        Assert.That(sites[3].Cell.Count(), Is.EqualTo(5)); // #4
        Assert.That(HasEdge(sites[3].Cell, 500, 1000, 500, 800), Is.True); // #4 has A-E
        Assert.That(HasEdge(sites[3].Cell, 1000, 500, 800, 500), Is.True); // #4 has D-H
        Assert.That(HasEdge(sites[3].Cell, 500, 800, 800, 500), Is.True); // #4 has E-H
        Assert.That(HasEdge(sites[3].Cell, 500, 1000, 1000, 1000), Is.True); // #4 has A-Z
        Assert.That(HasEdge(sites[3].Cell, 1000, 1000, 1000, 500), Is.True); // #4 has Z-D
        Assert.That(sites[4].Cell, Is.Not.Null);
        Assert.That(sites[4].Cell.Count(), Is.EqualTo(4)); // #5
        Assert.That(HasEdge(sites[4].Cell, 500, 800, 800, 500), Is.True); // #5 has E-H
        Assert.That(HasEdge(sites[4].Cell, 800, 500, 500, 200), Is.True); // #5 has H-G
        Assert.That(HasEdge(sites[4].Cell, 500, 200, 200, 500), Is.True); // #5 has G-F
        Assert.That(HasEdge(sites[4].Cell, 200, 500, 500, 800), Is.True); // #5 has F-E
    }
    ...
    public void FivePointsInASkewedKite()
    {
        ...
        Assert.That(sites[0].Cell, Is.Not.Null);
        Assert.That(sites[0].Cell.Count(), Is.EqualTo(5)); // #1
        Assert.That(HasEdge(sites[0].Cell, 400, 800, 400, 500), Is.True); // #1 has A-E
        Assert.That(HasEdge(sites[0].Cell, 0, 400, 300, 400), Is.True); // #1 has B-F
        Assert.That(HasEdge(sites[0].Cell, 300, 400, 400, 500), Is.True); // #1 has F-E
        Assert.That(HasEdge(sites[0].Cell, 0, 800, 400, 800), Is.True); // #1 has X-A
        Assert.That(HasEdge(sites[0].Cell, 0, 400, 0, 800), Is.True); // #1 has B-X
        Assert.That(sites[1].Cell, Is.Not.Null);
        Assert.That(sites[1].Cell.Count(), Is.EqualTo(5)); // #2
        Assert.That(HasEdge(sites[1].Cell, 400, 0, 400, 100), Is.True); // #2 has C-G
        Assert.That(HasEdge(sites[1].Cell, 0, 400, 300, 400), Is.True); // #2 has B-F
        Assert.That(HasEdge(sites[1].Cell, 400, 100, 300, 400), Is.True); // #2 has G-F
        Assert.That(HasEdge(sites[1].Cell, 400, 0, 0, 0), Is.True); // #2 has C-Y
        Assert.That(HasEdge(sites[1].Cell, 0, 0, 0, 400), Is.True); // #2 has Y-B
        Assert.That(sites[2].Cell, Is.Not.Null);
        Assert.That(sites[2].Cell.Count(), Is.EqualTo(5)); // #3
        Assert.That(HasEdge(sites[2].Cell, 800, 400, 700, 400), Is.True); // #3 has D-H
        Assert.That(HasEdge(sites[2].Cell, 400, 0, 400, 100), Is.True); // #3 has C-G
        Assert.That(HasEdge(sites[2].Cell, 700, 400, 400, 100), Is.True); // #3 has H-G
        Assert.That(HasEdge(sites[2].Cell, 800, 400, 800, 0), Is.True); // #3 has D-W
        Assert.That(HasEdge(sites[2].Cell, 800, 0, 400, 0), Is.True); // #3 has W-C
        Assert.That(sites[3].Cell, Is.Not.Null);
        Assert.That(sites[3].Cell.Count(), Is.EqualTo(5)); // #4
        Assert.That(HasEdge(sites[3].Cell, 400, 800, 400, 500), Is.True); // #4 has A-E
        Assert.That(HasEdge(sites[3].Cell, 800, 400, 700, 400), Is.True); // #4 has D-H
        Assert.That(HasEdge(sites[3].Cell, 400, 500, 700, 400), Is.True); // #4 has E-H
        Assert.That(HasEdge(sites[3].Cell, 400, 800, 800, 800), Is.True); // #4 has A-Z
        Assert.That(HasEdge(sites[3].Cell, 800, 800, 800, 400), Is.True); // #4 has Z-D
        Assert.That(sites[4].Cell, Is.Not.Null);
        Assert.That(sites[4].Cell.Count(), Is.EqualTo(4)); // #5
        Assert.That(HasEdge(sites[4].Cell, 400, 500, 700, 400), Is.True); // #5 has E-H
        Assert.That(HasEdge(sites[4].Cell, 700, 400, 400, 100), Is.True); // #5 has H-G
        Assert.That(HasEdge(sites[4].Cell, 400, 100, 300, 400), Is.True); // #5 has G-F
        Assert.That(HasEdge(sites[4].Cell, 300, 400, 400, 500), Is.True); // #5 has F-E
    }
    ...
    public void FivePointsInASkewedKite_Rotated90()
    {
        ...
        Assert.That(sites[0].Cell, Is.Not.Null);
        Assert.That(sites[0].Cell.Count(), Is.EqualTo(5)); // #1
        Assert.That(HasEdge(sites[0].Cell, 800, 400, 500, 400), Is.True); // #1 has A-E
        Assert.That(HasEdge(sites[0].Cell, 400, 800, 400, 500), Is.True); // #1 has B-F
        Assert.That(HasEdge(sites[0].Cell, 400, 500, 500, 400), Is.True); // #1 has F-E
        Assert.That(HasEdge(sites[0].Cell, 800, 800, 800, 400), Is.True); // #1 has X-A
        Assert.That(HasEdge(sites[0].Cell, 400, 800, 800, 800), Is.True); // #1 has B-X
        Assert.That(sites[1].Cell, Is.Not.Null);
        Assert.That(sites[1].Cell.Count(), Is.EqualTo(5)); // #2
        Assert.That(HasEdge(sites[1].Cell, 0, 400, 100, 400), Is.True); // #2 has C-G
        Assert.That(HasEdge(sites[1].Cell, 400, 800, 400, 500), Is.True); // #2 has B-F
        Assert.That(HasEdge(sites[1].Cell, 100, 400, 400, 500), Is.True); // #2 has G-F
        Assert.That(HasEdge(sites[1].Cell, 0, 400, 0, 800), Is.True); // #2 has C-Y
        Assert.That(HasEdge(sites[1].Cell, 0, 800, 400, 800), Is.True); // #2 has Y-B
        Assert.That(sites[2].Cell, Is.Not.Null);
        Assert.That(sites[2].Cell.Count(), Is.EqualTo(5)); // #3
        Assert.That(HasEdge(sites[2].Cell, 400, 0, 400, 100), Is.True); // #3 has D-H
        Assert.That(HasEdge(sites[2].Cell, 0, 400, 100, 400), Is.True); // #3 has C-G
        Assert.That(HasEdge(sites[2].Cell, 400, 100, 100, 400), Is.True); // #3 has H-G
        Assert.That(HasEdge(sites[2].Cell, 400, 0, 0, 0), Is.True); // #3 has D-W
        Assert.That(HasEdge(sites[2].Cell, 0, 0, 0, 400), Is.True); // #3 has W-C
        Assert.That(sites[3].Cell, Is.Not.Null);
        Assert.That(sites[3].Cell.Count(), Is.EqualTo(5)); // #4
        Assert.That(HasEdge(sites[3].Cell, 800, 400, 500, 400), Is.True); // #4 has A-E
        Assert.That(HasEdge(sites[3].Cell, 400, 0, 400, 100), Is.True); // #4 has D-H
        Assert.That(HasEdge(sites[3].Cell, 500, 400, 400, 100), Is.True); // #4 has E-H
        Assert.That(HasEdge(sites[3].Cell, 800, 400, 800, 0), Is.True); // #4 has A-Z
        Assert.That(HasEdge(sites[3].Cell, 800, 0, 400, 0), Is.True); // #4 has Z-D
        Assert.That(sites[4].Cell, Is.Not.Null);
        Assert.That(sites[4].Cell.Count(), Is.EqualTo(4)); // #5
        Assert.That(HasEdge(sites[4].Cell, 500, 400, 400, 100), Is.True); // #5 has E-H
        Assert.That(HasEdge(sites[4].Cell, 400, 100, 100, 400), Is.True); // #5 has H-G
        Assert.That(HasEdge(sites[4].Cell, 100, 400, 400, 500), Is.True); // #5 has G-F
        Assert.That(HasEdge(sites[4].Cell, 400, 500, 500, 400), Is.True); // #5 has F-E
    }
    ...
    public void FivePointsInASkewedKite_Rotated180()
    {
        ...
        Assert.That(sites[0].Cell, Is.Not.Null);
        Assert.That(sites[0].Cell.Count(), Is.EqualTo(5)); // #1
        Assert.That(HasEdge(sites[0].Cell, 400, 0, 400, 300), Is.True); // #1 has A-E
        Assert.That(HasEdge(sites[0].Cell, 800, 400, 500, 400), Is.True); // #1 has B-F
        Assert.That(HasEdge(sites[0].Cell, 500, 400, 400, 300), Is.True); // #1 has F-E
        Assert.That(HasEdge(sites[0].Cell, 800, 0, 400, 0), Is.True); // #1 has X-A
        Assert.That(HasEdge(sites[0].Cell, 800, 400, 800, 0), Is.True); // #1 has B-X
        Assert.That(sites[1].Cell, Is.Not.Null);
        Assert.That(sites[1].Cell.Count(), Is.EqualTo(5)); // #2
        Assert.That(HasEdge(sites[1].Cell, 400, 800, 400, 700), Is.True); // #2 has C-G
        Assert.That(HasEdge(sites[1].Cell, 800, 400, 500, 400), Is.True); // #2 has B-F
        Assert.That(HasEdge(sites[1].Cell, 400, 700, 500, 400), Is.True); // #2 has G-F
        Assert.That(HasEdge(sites[1].Cell, 400, 800, 800, 800), Is.True); // #2 has C-Y
        Assert.That(HasEdge(sites[1].Cell, 800, 800, 800, 400), Is.True); // #2 has Y-B
        Assert.That(sites[2].Cell, Is.Not.Null);
        Assert.That(sites[2].Cell.Count(), Is.EqualTo(5)); // #3
        Assert.That(HasEdge(sites[2].Cell, 0, 400, 100, 400), Is.True); // #3 has D-H
        Assert.That(HasEdge(sites[2].Cell, 400, 800, 400, 700), Is.True); // #3 has C-G
        Assert.That(HasEdge(sites[2].Cell, 100, 400, 400, 700), Is.True); // #3 has H-G
        Assert.That(HasEdge(sites[2].Cell, 0, 400, 0, 800), Is.True); // #3 has D-W
        Assert.That(HasEdge(sites[2].Cell, 0, 800, 400, 800), Is.True); // #3 has W-C
        Assert.That(sites[3].Cell, Is.Not.Null);
        Assert.That(sites[3].Cell.Count(), Is.EqualTo(5)); // #4
        Assert.That(HasEdge(sites[3].Cell, 400, 0, 400, 300), Is.True); // #4 has A-E
        Assert.That(HasEdge(sites[3].Cell, 0, 400, 100, 400), Is.True); // #4 has D-H
        Assert.That(HasEdge(sites[3].Cell, 400, 300, 100, 400), Is.True); // #4 has E-H
        Assert.That(HasEdge(sites[3].Cell, 400, 0, 0, 0), Is.True); // #4 has A-Z
        Assert.That(HasEdge(sites[3].Cell, 0, 0, 0, 400), Is.True); // #4 has Z-D
        Assert.That(sites[4].Cell, Is.Not.Null);
        Assert.That(sites[4].Cell.Count(), Is.EqualTo(4)); // #5
        Assert.That(HasEdge(sites[4].Cell, 400, 300, 100, 400), Is.True); // #5 has E-H
        Assert.That(HasEdge(sites[4].Cell, 100, 400, 400, 700), Is.True); // #5 has H-G
        Assert.That(HasEdge(sites[4].Cell, 400, 700, 500, 400), Is.True); // #5 has G-F
        Assert.That(HasEdge(sites[4].Cell, 500, 400, 400, 300), Is.True); // #5 has F-E
    }
    ...
    public void FivePointsInASkewedKite_Rotated270()
    {
        ...
        Assert.That(sites[0].Cell, Is.Not.Null);
        Assert.That(sites[0].Cell.Count(), Is.EqualTo(5)); // #1
        Assert.That(HasEdge(sites[0].Cell, 0, 400, 300, 400), Is.True); // #1 has A-E
        Assert.That(HasEdge(sites[0].Cell, 400, 0, 400, 300), Is.True); // #1 has B-F
        Assert.That(HasEdge(sites[0].Cell, 400, 300, 300, 400), Is.True); // #1 has F-E
        Assert.That(HasEdge(sites[0].Cell, 0, 0, 0, 400), Is.True); // #1 has X-A
        Assert.That(HasEdge(sites[0].Cell, 400, 0, 0, 0), Is.True); // #1 has B-X
        Assert.That(sites[1].Cell, Is.Not.Null);
        Assert.That(sites[1].Cell.Count(), Is.EqualTo(5)); // #2
        Assert.That(HasEdge(sites[1].Cell, 800, 400, 700, 400), Is.True); // #2 has C-G
        Assert.That(HasEdge(sites[1].Cell, 400, 0, 400, 300), Is.True); // #2 has B-F
        Assert.That(HasEdge(sites[1].Cell, 700, 400, 400, 300), Is.True); // #2 has G-F
        Assert.That(HasEdge(sites[1].Cell, 800, 400, 800, 0), Is.True); // #2 has C-Y
        Assert.That(HasEdge(sites[1].Cell, 800, 0, 400, 0), Is.True); // #2 has Y-B
        Assert.That(sites[2].Cell, Is.Not.Null);
        Assert.That(sites[2].Cell.Count(), Is.EqualTo(5)); // #3
        Assert.That(HasEdge(sites[2].Cell, 400, 800, 400, 700), Is.True); // #3 has D-H
        Assert.That(HasEdge(sites[2].Cell, 800, 400, 700, 400), Is.True); // #3 has C-G
        Assert.That(HasEdge(sites[2].Cell, 400, 700, 700, 400), Is.True); // #3 has H-G
        Assert.That(HasEdge(sites[2].Cell, 400, 800, 800, 800), Is.True); // #3 has D-W
        Assert.That(HasEdge(sites[2].Cell, 800, 800, 800, 400), Is.True); // #3 has W-C
        Assert.That(sites[3].Cell, Is.Not.Null);
        Assert.That(sites[3].Cell.Count(), Is.EqualTo(5)); // #4
        Assert.That(HasEdge(sites[3].Cell, 0, 400, 300, 400), Is.True); // #4 has A-E
        Assert.That(HasEdge(sites[3].Cell, 400, 800, 400, 700), Is.True); // #4 has D-H
        Assert.That(HasEdge(sites[3].Cell, 300, 400, 400, 700), Is.True); // #4 has E-H
        Assert.That(HasEdge(sites[3].Cell, 0, 400, 0, 800), Is.True); // #4 has A-Z
        Assert.That(HasEdge(sites[3].Cell, 0, 800, 400, 800), Is.True); // #4 has Z-D
        Assert.That(sites[4].Cell, Is.Not.Null);
        Assert.That(sites[4].Cell.Count(), Is.EqualTo(4)); // #5
        Assert.That(HasEdge(sites[4].Cell, 300, 400, 400, 700), Is.True); // #5 has E-H
        Assert.That(HasEdge(sites[4].Cell, 400, 700, 700, 400), Is.True); // #5 has H-G
        Assert.That(HasEdge(sites[4].Cell, 700, 400, 400, 300), Is.True); // #5 has G-F
        Assert.That(HasEdge(sites[4].Cell, 400, 300, 300, 400), Is.True); // #5 has F-E
    }

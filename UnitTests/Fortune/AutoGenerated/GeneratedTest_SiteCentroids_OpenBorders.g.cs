...
public class GeneratedTest_SiteCentroids_OpenBorders
{
    ...
    public void ThreePointsInAWedgeTowardsCornerOffset_Rotated90()
    {
        ...
        Assert.That(sites[2].Centroid.X, Is.EqualTo(533.33).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(566.67).Within(0.01));
    }
    ...
    public void ThreePointsInAWedgeTowardsSideOffsetFromMiddle()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(600.00).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(433.33).Within(0.01));
    ...
    public void ThreePointsInAWedgeTowardsSideOffsetFromMiddle_Rotated90()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(433.33).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(400.00).Within(0.01));
    ...
    public void ThreePointsInAWedgeTowardsSideOffsetFromMiddle_Rotated180()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(400.00).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(566.67).Within(0.01));
    ...
    public void ThreePointsInAWedgeTowardsSideOffsetFromMiddle_Rotated270()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(566.67).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(600.00).Within(0.01));
    ...
    public void FourPointsSurroundingAPointOffsetFromMiddle()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(219.05).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(371.43).Within(0.01));
        ...
        Assert.That(sites[3].Centroid.X, Is.EqualTo(780.95).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(371.43).Within(0.01));
    ...
    public void FourPointsSurroundingAPointOffsetFromMiddle_Rotated90()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(371.43).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(780.95).Within(0.01));
        ...
        Assert.That(sites[3].Centroid.X, Is.EqualTo(371.43).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(219.05).Within(0.01));
        // Centroid of #5 in E-A-D-H is at ~(644, 500) (using generic closed polygon formula)
        Assert.That(sites[4].Centroid.X, Is.EqualTo(644.44).Within(0.01));
    ...
    public void FourPointsSurroundingAPointOffsetFromMiddle_Rotated180()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(780.95).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(628.57).Within(0.01));
        ...
        Assert.That(sites[3].Centroid.X, Is.EqualTo(219.05).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(628.57).Within(0.01));
        // Centroid of #5 in A-D-H-E is at ~(500, 356) (using generic closed polygon formula)
        Assert.That(sites[4].Centroid.X, Is.EqualTo(500.00).Within(0.01));
        Assert.That(sites[4].Centroid.Y, Is.EqualTo(355.56).Within(0.01));
    }
    ...
    public void FourPointsSurroundingAPointOffsetFromMiddle_Rotated270()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(628.57).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(219.05).Within(0.01));
        ...
        Assert.That(sites[3].Centroid.X, Is.EqualTo(628.57).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(780.95).Within(0.01));
        // Centroid of #5 in D-H-E-A is at ~(356, 500) (using generic closed polygon formula)
        Assert.That(sites[4].Centroid.X, Is.EqualTo(355.56).Within(0.01));
        Assert.That(sites[4].Centroid.Y, Is.EqualTo(500.00).Within(0.01));
    }
    ...
    public void FivePointsInAForkedTallCross()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(271.79).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(623.08).Within(0.01));
        ...
        Assert.That(sites[3].Centroid.X, Is.EqualTo(666.67).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(266.67).Within(0.01));
        // Centroid of #5 in D-B-A-F is at ~(728, 623) (using generic closed polygon formula)
        Assert.That(sites[4].Centroid.X, Is.EqualTo(728.21).Within(0.01));
        Assert.That(sites[4].Centroid.Y, Is.EqualTo(623.08).Within(0.01));
    }
    ...
    public void FivePointsInAForkedTallCross_Rotated90()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(623.08).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(728.21).Within(0.01));
        ...
        Assert.That(sites[3].Centroid.X, Is.EqualTo(266.67).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(333.33).Within(0.01));
        // Centroid of #5 in B-A-F-D is at ~(623, 272) (using generic closed polygon formula)
        Assert.That(sites[4].Centroid.X, Is.EqualTo(623.08).Within(0.01));
        Assert.That(sites[4].Centroid.Y, Is.EqualTo(271.79).Within(0.01));
    }
    ...
    public void FivePointsInAForkedTallCross_Rotated180()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(728.21).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(376.92).Within(0.01));
        ...
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(733.33).Within(0.01));
        // Centroid of #5 in B-A-F-D is at ~(272, 377) (using generic closed polygon formula)
        Assert.That(sites[4].Centroid.X, Is.EqualTo(271.79).Within(0.01));
        Assert.That(sites[4].Centroid.Y, Is.EqualTo(376.92).Within(0.01));
    }
    ...
    public void FivePointsInAForkedTallCross_Rotated270()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(376.92).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(271.79).Within(0.01));
        ...
        Assert.That(sites[3].Centroid.X, Is.EqualTo(733.33).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(666.67).Within(0.01));
        // Centroid of #5 in F-D-B-A is at ~(377, 728) (using generic closed polygon formula)
        Assert.That(sites[4].Centroid.X, Is.EqualTo(376.92).Within(0.01));
        Assert.That(sites[4].Centroid.Y, Is.EqualTo(728.21).Within(0.01));
    }
    ...
    public void FivePointsInAForkedStubbyCross_Rotated180()
    {
        ...
        // Centroid of #3 in G-A-E is at ~(667, 800) (using generic closed polygon formula)
        Assert.That(sites[2].Centroid.X, Is.EqualTo(666.67).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(800.00).Within(0.01));
        // Centroid of #4 in G-F-A is at ~(333, 800) (using generic closed polygon formula)
        Assert.That(sites[3].Centroid.X, Is.EqualTo(333.33).Within(0.01));
    ...
    public void FivePointsInAForkedStubbyCross_Rotated270()
    {
        ...
        // Centroid of #3 in G-A-E is at ~(800, 333) (using generic closed polygon formula)
        Assert.That(sites[2].Centroid.X, Is.EqualTo(800.00).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(333.33).Within(0.01));
        // Centroid of #4 in F-A-G is at ~(800, 667) (using generic closed polygon formula)
        Assert.That(sites[3].Centroid.X, Is.EqualTo(800.00).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(666.67).Within(0.01));
    ...
    public void SixPointsInADoubleCross()
    {
        ...
        Assert.That(sites[4].Centroid.Y, Is.EqualTo(200.00).Within(0.01));
        // Centroid of #6 in F-A-E is at ~(667, 200) (using generic closed polygon formula)
        Assert.That(sites[5].Centroid.X, Is.EqualTo(666.67).Within(0.01));
        Assert.That(sites[5].Centroid.Y, Is.EqualTo(200.00).Within(0.01));
    }
    ...
    public void SixPointsInADoubleCross_Rotated90()
    {
        ...
        Assert.That(sites[4].Centroid.X, Is.EqualTo(200.00).Within(0.01));
        ...
        Assert.That(sites[5].Centroid.X, Is.EqualTo(200.00).Within(0.01));
        Assert.That(sites[5].Centroid.Y, Is.EqualTo(333.33).Within(0.01));
    }
    ...
    public void FivePointsInARegularKite()
    {
        ...
        // Centroid of #1 in E-A-B-F is at ~(296, 704) (using generic closed polygon formula)
        Assert.That(sites[0].Centroid.X, Is.EqualTo(295.83).Within(0.01));
        Assert.That(sites[0].Centroid.Y, Is.EqualTo(704.17).Within(0.01));
        // Centroid of #2 in G-F-B-C is at ~(296, 296) (using generic closed polygon formula)
        Assert.That(sites[1].Centroid.X, Is.EqualTo(295.83).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(295.83).Within(0.01));
        // Centroid of #3 in D-H-G-C is at ~(704, 296) (using generic closed polygon formula)
        Assert.That(sites[2].Centroid.X, Is.EqualTo(704.17).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(295.83).Within(0.01));
        // Centroid of #4 in A-E-H-D is at ~(704, 704) (using generic closed polygon formula)
        Assert.That(sites[3].Centroid.X, Is.EqualTo(704.17).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(704.17).Within(0.01));
    ...
    public void FivePointsInASkewedKite()
    {
        ...
        // Centroid of #1 in A-B-F-E is at ~(260, 540) (using generic closed polygon formula)
        Assert.That(sites[0].Centroid.X, Is.EqualTo(260.00).Within(0.01));
        Assert.That(sites[0].Centroid.Y, Is.EqualTo(540.00).Within(0.01));
        // Centroid of #2 in F-B-C-G is at ~(244, 259) (using generic closed polygon formula)
        Assert.That(sites[1].Centroid.X, Is.EqualTo(243.59).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(258.97).Within(0.01));
        // Centroid of #3 in D-H-G-C is at ~(576, 224) (using generic closed polygon formula)
        Assert.That(sites[2].Centroid.X, Is.EqualTo(576.19).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(223.81).Within(0.01));
        // Centroid of #4 in A-E-H-D is at ~(541, 556) (using generic closed polygon formula)
        Assert.That(sites[3].Centroid.X, Is.EqualTo(541.03).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(556.41).Within(0.01));
    ...
    public void FivePointsInASkewedKite_Rotated90()
    {
        ...
        // Centroid of #1 in B-F-E-A is at ~(540, 540) (using generic closed polygon formula)
        Assert.That(sites[0].Centroid.X, Is.EqualTo(540.00).Within(0.01));
        Assert.That(sites[0].Centroid.Y, Is.EqualTo(540.00).Within(0.01));
        // Centroid of #2 in B-C-G-F is at ~(259, 556) (using generic closed polygon formula)
        Assert.That(sites[1].Centroid.X, Is.EqualTo(258.97).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(556.41).Within(0.01));
        // Centroid of #3 in G-C-D-H is at ~(224, 224) (using generic closed polygon formula)
        Assert.That(sites[2].Centroid.X, Is.EqualTo(223.81).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(223.81).Within(0.01));
        // Centroid of #4 in A-E-H-D is at ~(556, 259) (using generic closed polygon formula)
        Assert.That(sites[3].Centroid.X, Is.EqualTo(556.41).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(258.97).Within(0.01));
    ...
    public void FivePointsInASkewedKite_Rotated180()
    {
        ...
        // Centroid of #1 in B-F-E-A is at ~(540, 260) (using generic closed polygon formula)
        Assert.That(sites[0].Centroid.X, Is.EqualTo(540.00).Within(0.01));
        Assert.That(sites[0].Centroid.Y, Is.EqualTo(260.00).Within(0.01));
        // Centroid of #2 in C-G-F-B is at ~(556, 541) (using generic closed polygon formula)
        Assert.That(sites[1].Centroid.X, Is.EqualTo(556.41).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(541.03).Within(0.01));
        // Centroid of #3 in G-C-D-H is at ~(224, 576) (using generic closed polygon formula)
        Assert.That(sites[2].Centroid.X, Is.EqualTo(223.81).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(576.19).Within(0.01));
        // Centroid of #4 in E-H-D-A is at ~(259, 244) (using generic closed polygon formula)
        Assert.That(sites[3].Centroid.X, Is.EqualTo(258.97).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(243.59).Within(0.01));
    ...
    public void FivePointsInASkewedKite_Rotated270()
    {
        ...
        // Centroid of #1 in F-E-A-B is at ~(260, 260) (using generic closed polygon formula)
        Assert.That(sites[0].Centroid.X, Is.EqualTo(260.00).Within(0.01));
        Assert.That(sites[0].Centroid.Y, Is.EqualTo(260.00).Within(0.01));
        // Centroid of #2 in C-G-F-B is at ~(541, 244) (using generic closed polygon formula)
        Assert.That(sites[1].Centroid.X, Is.EqualTo(541.03).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(243.59).Within(0.01));
        // Centroid of #3 in D-H-G-C is at ~(576, 576) (using generic closed polygon formula)
        Assert.That(sites[2].Centroid.X, Is.EqualTo(576.19).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(576.19).Within(0.01));
        // Centroid of #4 in H-D-A-E is at ~(244, 541) (using generic closed polygon formula)
        Assert.That(sites[3].Centroid.X, Is.EqualTo(243.59).Within(0.01));
        Assert.That(sites[3].Centroid.Y, Is.EqualTo(541.03).Within(0.01));
    ...
    public void ThreePointsMeetingPastBorderPerpendicularly()
    {
        ...
        Assert.That(sites[2].Centroid.X, Is.EqualTo(488.89).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(500.00).Within(0.01));
    }
    ...
    public void ThreePointsMeetingPastBorderPerpendicularly_Rotated90()
    {
        ...
        Assert.That(sites[2].Centroid.X, Is.EqualTo(500.00).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(511.11).Within(0.01));
    }
    ...
    public void ThreePointsMeetingPastBorderPerpendicularly_Rotated180()
    {
        ...
        Assert.That(sites[2].Centroid.X, Is.EqualTo(511.11).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(500.00).Within(0.01));
    }
    ...
    public void ThreePointsMeetingPastBorderPerpendicularly_Rotated270()
    {
        ...
        Assert.That(sites[2].Centroid.X, Is.EqualTo(500.00).Within(0.01));
        Assert.That(sites[2].Centroid.Y, Is.EqualTo(488.89).Within(0.01));
    }
    ...
    public void ThreePointsMeetingSharplyPastBorderPerpendicularly_Rotated90()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(900.00).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(1100.00).Within(0.01));
    ...
    public void ThreePointsMeetingSharplyPastBorderPerpendicularly_Rotated180()
    {
        ...
        Assert.That(sites[1].Centroid.X, Is.EqualTo(1100.00).Within(0.01));
        Assert.That(sites[1].Centroid.Y, Is.EqualTo(300.00).Within(0.01));
